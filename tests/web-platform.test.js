...
assert.ok(indexHtml.includes('href="/styles.css?v=drive-mental-v44"'));
assert.ok(indexHtml.includes('src="/app.js?v=drive-mental-v44"'));
assert.ok(indexHtml.includes('src="/platform.js?v=drive-mental-v44"'));
assert.ok(indexHtml.includes('src="/runtime-config.js?v=drive-mental-v44"'));
assert.ok(indexHtml.includes('src="/supabase-client.js?v=drive-mental-v44"'));
...
assert.ok(serviceWorker.includes("drive-mental-web-v44"));
...
assert.ok(runtimeConfigSource.includes("https://qgvlkpaociypyxduvsqm.supabase.co"));
assert.ok(runtimeConfigSource.includes("sb_publishable_1Lh5PLaeNXnD_6DFGa6H6A_yhqO0Ocs"));
