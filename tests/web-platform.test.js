...
assert.ok(runtimeConfigSource.includes("https://horsbnzwozvpboejsbww.supabase.co"));
assert.ok(runtimeConfigSource.includes("sb_publishable_htTWzhGBTpMH66FYmiHO-A_yJ4pF50q"));
