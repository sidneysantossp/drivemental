...
assert.ok(indexHtml.includes('href="/styles.css?v=cycle-v20"'));
assert.ok(indexHtml.includes('src="/app.js?v=cycle-v20"'));
assert.ok(indexHtml.includes('src="/platform.js?v=cycle-v20"'));
assert.ok(indexHtml.includes('src="/runtime-config.js?v=cycle-v20"'));
assert.ok(indexHtml.includes('src="/supabase-client.js?v=cycle-v20"'));
...
assert.ok(serviceWorker.includes("drive-astral-web-v20"));
