...
assert.ok(indexHtml.includes('href="/styles.css?v=drive-mental-v40"'));
assert.ok(indexHtml.includes('src="/app.js?v=drive-mental-v40"'));
assert.ok(indexHtml.includes('src="/platform.js?v=drive-mental-v40"'));
assert.ok(indexHtml.includes('src="/runtime-config.js?v=drive-mental-v40"'));
assert.ok(indexHtml.includes('src="/supabase-client.js?v=drive-mental-v40"'));
...
assert.ok(serviceWorker.includes("drive-mental-web-v40"));
