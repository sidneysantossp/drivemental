...
assert.ok(platformProfileHtml.includes("Baixar backup local"));
assert.ok(platformProfileHtml.includes("estado dispon&iacute;vel neste navegador"));
assert.ok(platformProfileHtml.includes("n&atilde;o &eacute; uma exporta&ccedil;&atilde;o completa da conta sincronizada"));
assert.ok(!platformProfileHtml.includes("<strong>Exportar meus dados</strong>"));
